                ...
                <div className='mt-7 px-4 space-y-7'>
                    <div className='flex gap-3 items-center'>
                        ...
                        <div className='text-white'>
                            ...
                            <p className='text-gray-200'>abhishekkumar63871@gmail.com
                            </p>
                        </div>
                    </div>
                    <div className='flex gap-3 items-center'>
                        ...
                        <div className='text-white'>
                            ...
                            <p className='text-gray-200'>+91 6387104522</p>
                        </div>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <div className='bg-gray-700 p-2 rounded-md shadow'>
                        ...
                        <div className='text-white'>
                            ...
                            <p className='text-gray-200'>8 May, 2004</p>
                        </div>
                    </div>
                    <div className='flex gap-3 items-center'>
                        <div className='bg-gray-700 p-2 rounded-md shadow'>
                        ...
                        <div className='text-white'>
                            ...
                            <p className='text-gray-200'>Gorakhpur, India</p>
                        </div>
                    </div>
                </div>
            </div>
